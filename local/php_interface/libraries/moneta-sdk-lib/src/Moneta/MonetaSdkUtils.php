...
class MonetaSdkUtils
{
    ...
    const EXCEPTION_NO_PERMISSIONS = 'Please set 0755 permissions to the "logs" folder';
	...
	public static function addToLog($message)
	{
        ...
        $result = null;
        if (substr(sprintf('%o', fileperms(__DIR__ . self::LOGS_FILES_PATH)), -4) != '0755') {
            if (!@chmod(__DIR__ . self::LOGS_FILES_PATH, 0755)) {
