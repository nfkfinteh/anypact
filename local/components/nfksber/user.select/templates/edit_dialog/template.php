...
?>
<div>
    <input type="text" class="editbox" id="us_name" value="" name="us_name" placeholder="Выбрать пользователей" autocomplete="off">
</div>
<div class="select-user">
    ...
    <div class="select-user-popup custom-scroll">
        ...
        ?>
            <div class="user-not_found">Пользователи не найдены</div>
        <?
        endif;
        ?>
    </div>
