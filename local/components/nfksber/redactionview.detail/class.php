...
{       
    ...
    private function sendEmail(){
        $rsUser = CUser::GetList(($by="personal_country"), ($order="desc"), array("ID" => $this->arResult["CONTRACT_PROPERTY"]["CONTRACT_PROPERTY"]["USER_A"]["VALUE"]), array("FIELDS" => array("ID", "EMAIL")));
