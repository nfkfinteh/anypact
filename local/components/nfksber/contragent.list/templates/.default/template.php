...
<div class="grid-view__title">Пользователи</div>
<div class="js-userwrap__pagination">
    <?if($_REQUEST['pagination'] == 'user'):?>
...
<?if(!empty($arResult["COMPANY"])):?>
    <div class="grid-view__title">Компании</div>
    <div class="js-companywrap__pagination">
        <?if($_REQUEST['pagination'] == 'company'):?>
            <?$GLOBALS['APPLICATION']->RestartBuffer();?>
        <?endif?>
        <div class="row grid-view">
...
<?if(empty($arResult["USER"]) && empty($arResult["COMPANY"])):?>
