 ...
 <div class="tender cardDogovor" style="margin-bottom: 100px;">
    <div class="row">
        ...
        <div class="tools_redactor">
            ...
            <button type="button" class="btn btn-nfk btn-default form_text"  id="btn-noedit" data-toggle="tooltip" data-placement="left" title="Запретить контрагентам редактировать выделенный текст"><span class="glyphicon glyphicon-ban-circle"></span></button>
            <button type="button" class="btn btn-nfk btn-default space_right" id="btn-data" data-toggle="tooltip" data-placement="left" title="Вставить поле динамической даты"><span class="glyphicon glyphicon-calendar"></span></button>
