<form action="<?=$arResult["FORM_ACTION"]?>" class="form-filter__user">
    <label>Имя /  Название компании</label>
        <input type="text" name="NAME" value="<?=$arResult['POST_NAME']?>" maxlength="50" class="filter-key" placeholder="Введите имя / Название компании" />
    <label>Город</label>
        ...
        <input type="hidden" name="ACTION" value="search_<?=$arParams['TYPE_FILTER']?>" />
