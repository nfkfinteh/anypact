...
else
{
	...
	$arResult = array(
		"FOLDER" => "",
		"URL_TEMPLATES" => array(
			"pacts" => htmlspecialcharsbx($APPLICATION->GetCurPage()),
...
if($USER -> IsAuthorized()){
	$res = CUser::GetList(($by="personal_country"), ($order="desc"), array("ID" => $USER->GetID(), "!UF_MONETA_UNIT_ID" => FALSE, "!UF_MONETA_ACCOUNT_ID" => FALSE), array("FIELDS" => array("ID")));
	if($arUser = $res->Fetch()) {
		$this->includeComponentTemplate('wallet');
	}else{
