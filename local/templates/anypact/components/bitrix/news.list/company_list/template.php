...
<?else:?>
    <div class="d-flex flex-column align-items-center text-center mt-5 pt-5 mb-5" >
        ...
        <h3 class="text-uppercase font-weight-bold mt-3" style="max-width: 550px">В текущий момент у Вас нет активных Компаний, если вы создавали Компанию то в текущий момент она находится на проверке, после успешной проверки Ваша Компания будет автоматически активирована.</h3>
