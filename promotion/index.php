...
<section class="section-100r">
    ...
    <div class="container-akcii container-akcii-bg">
        <div class="row-end">
            ...
            <?}?>
            <span class="text-desc">*Предложение распространяется на первые 10 000 зарегистрировавшихся пользователей, при выполнении указанных выше пунктов, а также при условии, что ранее Вы не регистрировались на сайте AnyPact.ru. Предложение заканчивает свое действие 31.08.2021.</span>
        </div>
    </div>
</section>
<?/*}else{?>
