...
<section class="section-100r">
    ...
    <div class="container-akcii container-akcii-bg">
        <div class="row-end">
            ...
            <?}?>
            <span class="text-desc">*Предложение распространяется на первую тысячу зарегистрировавшихся пользователей, при выполнении указанных выше пунктов, а также при условии, что ранее Вы не регистрировались на сайте AnyPact.ru. Предложение заканчивает свое действие 30.04.2021.</span>
        </div>
    </div>
</section>
<?/*}else{?>
