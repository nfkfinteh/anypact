    ...
    <section class="section-50r">
        <div class="container-akcii">
            ...
            <div class="regbox-akcii">
                <span class="text-desc">Зарегистрируйся на сайте AnyPact.ru и получи деньги<br> на мобильный телефон.*</span>
            ...
            <div class="row-end">
                <img src="<?=SITE_TEMPLATE_PATH?>/image/coin-bg.png" alt=""/>
                <h2>
                    <span class="h1-big">
                        Всё!
                    </span>
                ...
                <span class="text-desc">*Предложение распространяется на первую тысячу зарегистрировавшихся пользователей, при условии, что ранее Вы не регистрировались на сайте AnyPact.ru. Предложение заканчивает свое действие 31.10.2020.</span>
            </div>
        </div>
    </section>
<?}else{
